...
<script language="javascript" type="text/javascript" src="./YongHuGuanLi_files/common_util.js"></script>
...
<frame name="title" scrolling="no" target="contents" src="./YongHuGuanLi_files/title.htm" marginwidth="0" marginheight="0" noresize="">
<frameset rows="*" cols="180, *">
<frame name="contents" noresize="" target="main" src="./YongHuGuanLi_files/menu_admin.htm" marginwidth="0" marginheight="0" scrolling="auto">
<frameset rows="40, *" cols="*" framespacing="0" frameborder="0" border="0">
<frame name="navigator" src="./YongHuGuanLi_files/navigator.htm" target="navigator" scrolling="no" marginwidth="0" marginheight="0" noresize="">
<frame name="main" src="./YongHuGuanLi_files/userManage.htm" target="_self" scrolling="auto" marginwidth="0" marginheight="0" noresize="">
<noframes>
&lt;body&gt;
